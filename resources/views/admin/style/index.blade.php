          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">
                  <a href="{{ route('style.add') }}">Add-Styles</a>
                </li>
      ...
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a class="btn btn-primary" href="{{ route('style.edit', $style->id)}}">EDIT</a>
            </td>
            <td>
              <!-- <form action="{{route('style.destory', $style->id)}}" method="post">
                                <input type="hidden" name="_method" value="DELETE">
                                @csrf
                                <button id="btnDelete" class="btn btn-danger btn-sm">Delete</button>
                            </form> -->
              <form method="POST" action="{{route('style.destory', $style->id)}}">
                @csrf
