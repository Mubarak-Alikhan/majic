            ...
            <div class="row mb-5">
                  ...
                  @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <label for="companyName" class="form_label"
                                    >Company Name</label
                                >
                                <input
                                    type="text"
                            ...
                            <div class="col-12 mb-3">
                                <label for="cityTown" class="form_label"
                                    >City / Town</label
                                >
                                <input
                                    type="text"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="postcodeZIP" class="form_label"
                                    >Postcode / ZIP</label
                                >
                                <input
                                    type="text"
                            ...
                            <div class="col-12 mb-3">
                                <label for="orderNote" class="form_label"
                                    >Order Note</label
                                >
                                <textarea
                                    id="orderNote"
                            ...
                            <div class="col-12">
                                <input
                                    class="form-check-input checkout_check_input"
                                    type="radio"
                ...
                <div class="col-md-5">
                    <div class="checkout_right mx-md-5 p-md-4 p-3">
                        ...
                        <div class="mt-3">
                            <label for="coupon" class="form_label mb-2"
                                >Have A Coupon ?</label
                            >
                            <div class="row g-0">
                                <div class="col-sm-8">
                                    <input
                                        ...
                                        class="form-control bg-white rounded-0 height-50 border-black"
                                    />
                                </div>
                                <div class="col-sm-4">
                                    <button
                                        class="btn-3 border-0 p-0 h-100 w-100 d-block"
                                    >
                                        Update Cart
                                    </button>
                                </div>
                        ...
                        <div id="credit_cards">
                            ...
                            <div class="row g-3 pt-md-4">
                                <div class="col-md-12">
                                    <input
                                        type="text"
                                        class="form-control border-0 ps-md-4 p-md-3 rounded-0 text-dark my-1"
                                ...
                                <div class="col-md-12">
                                    <input
                                        type="text"
                                        class="form-control ps-md-4 p-md-3 rounded-0 border-0 text-dark my-1"
                                ...
                                <div class="col-12">
                                    <button
                                        ...
                                        class="btn btn-primary btn-3 rounded-0 w-100 border-0 py-3"
                                    >
                                        Place Order
                                    </button>
                                </div>
