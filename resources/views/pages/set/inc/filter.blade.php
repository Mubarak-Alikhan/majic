    ...
    <div class="col-md-3" data-aos="fade-down">
        <ul class="filters">
                ...
                <form class="pt-md-3 pt-2">
                    <div class="border-0 position-relative">
                        <input
                            ...
                            class="fw-normal fs-14 form-control rounded-0 py-3 px-3 border-dark"
                        />
                        <button
                            class="border-0 bg-transparent position-absolute searchIcon"
                        >
                            <img
            ...
            <li class="pt-md-5 pt-3">
                <span class="fs-5 font-1 fw-600 text-uppercase"
                    >collections</span
                >
                ...
                <div class="pt-3">
                    <p class="py-2 border-bottom fw-500">
                        <a
                            href="{{ route('web.collection', $collection->slug)}}"
            ...
            <li class="pt-md-5 pt-3">
                <span class="fs-5 font-1 fw-600 text-uppercase"
                    >Jewelry piece type</span
                >
                @foreach($categories as $category)
                <div class="pt-3">
                    <p class="py-2 border-bottom fw-500">
                        <a
                            href="{{ url('view-product/'.$category->slug)}}"
                            class="d-flex justify-content-between align-items-center"
                        >
