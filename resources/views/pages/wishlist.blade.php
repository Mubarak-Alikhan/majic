          ...
          @foreach( $wishlists as $wish)
             <div class="cart-box bg-form p-4 mb-5">
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-3">
                         <img src="{{$wish->products->image}}" alt="" class="img-fluid w-100">
                     </div>
                     <div class="col-md-9">
                         <div class="row">
                             <div class="col-md-6">
                                 ...
                                 <div class="row">
                                     ...
                                     <p class="fs-14 fw-600 mb-2 col-sm-5">{{$wish->products->name}}</p>
                                 </div>
                                 <div class="row">
                             ...
                             <div class="col-md-6 text-end">
                                 ...
                                 <a href="{{ route('addcart', $wish->products->id) }}" class="fs-14 text-red text-decoration-underline">
                                     Add to cart
                                        </a>
                                 <h3 class="fw-500 mt-md-5 mt-2">${{$wish->products->selling_price}}</h3>
                             </div>
            ...
            <div class="d-flex justify-content-center">
                <h1 style="display: contents; color: blue; text-align: right;"> There is no Product in wishlists</h1>
            </div>
            @endif
