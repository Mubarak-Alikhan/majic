...
<div class="col">
    <div class="product_box py-md-3">
        <div class="top position-relative">
            <img src="{{ '/'.$product->file}}" alt="" class="img-fluid w-100" />
            <div class="onhover-btn position-absolute w-100 text-center">
                <a
                    href="{{ route('web.single-product', $product->slug)}}"
                    class="btn-3"
            ...
            <div class="onhover-icons position-absolute">
                <div class="d-flex justify-content-center">
                    <a
                        href="javascript:;"
                        class="icon-box d-flex justify-content-center align-items-center mr-30"
                    >
                        <svg
                    ...
                    <a
                        href="javascript:;"
                        class="icon-box d-flex justify-content-center align-items-center ml-30"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="27.999"
                            viewBox="0 0 24 27.999"
                        >
                            <path
                                id="Bag"
                                d="M1535.282,38.8a.865.865,0,0,0-.854-.8h-4.286v-1.75a5.144,5.144,0,1,0-10.286,0V38h-4.286a.865.865,0,0,0-.854.8L1513,58.045a.886.886,0,0,0,.221.669.849.849,0,0,0,.633.285h22.285a.849.849,0,0,0,.633-.285.886.886,0,0,0,.221-.669Zm-13.711-2.546a3.429,3.429,0,1,1,6.857,0V38h-6.857Zm-6.775,21,1.558-17.5h3.5v1.993a1.714,1.714,0,1,0,1.714,0V39.749h6.857v1.993a1.714,1.714,0,1,0,1.714,0V39.749h3.5l1.558,17.5Z"
                                transform="translate(-1513 -30.999)"
                                fill="#fff"
                            />
                        </svg>
                    </a>
